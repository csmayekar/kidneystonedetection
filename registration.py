...
label=tk.Label(root,text="Registeration Form",
               ...
               bg="black",
               fg="white")
label.place(x=610,y=90)
canvas=tk.Canvas(root,background="white",borderwidth=5)
canvas.place(x=600,y=150,width=400,height=590)
...
entry.place(x=780,y=520)

a1=tk.Label(root,text="Gender:",font=("Calibri",10),bg="white").place(x=650,y=590)

tk.Radiobutton(root,text="Male",font=("Calibri",10),bg="white",value=1,variable=var).place(x=730,y=590)
tk.Radiobutton(root,text="FeMale",font=("Calibri",10),bg="white",value=2,variable=var).place(x=800,y=590)
...
btn.place(x=690,y=650)



register2=tk.Label(root,text="Already have an account? " ,bg="white",font=('Cambria',11)).place(x=780,y=700)
