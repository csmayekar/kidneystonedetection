...
basepath= os.path.normpath('E:\project 2023\Kidney Stone Disease Detection-100%\Kidney Stone Disease Detection-100%')
...
trainingPath = os.path.sep.join([basepath, "traning_set"])
